...
function renderizarTabla() {
  ...
  datosTabla.forEach((dato, index) => {
    ...
    fila.innerHTML = `
      ...
      <td class="celda-blog" style="max-width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${dato.blog || ''}</td>
      <td class="celda-meta" style="max-width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${dato.meta || ''}</td>
